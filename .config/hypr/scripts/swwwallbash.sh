...
echo "wallbashOut:${wallbashOut}"
echo target:${target} appexe:${appexe}

echo "s/<wallbash_pry0>/${dcol_pry0}/g"
echo "s/<wallbash_txt0>/${dcol_txt0}/g"
echo "s/<wallbash_0xa1>/${dcol_0xa1}/g"
echo "s/<wallbash_0xa2>/${dcol_0xa2}/g"
echo "s/<wallbash_0xa3>/${dcol_0xa3}/g"
echo "s/<wallbash_0xa4>/${dcol_0xa4}/g"
echo "s/<wallbash_pry1>/${dcol_pry1}/g"
echo "s/<wallbash_txt1>/${dcol_txt1}/g"
echo "s/<wallbash_1xa1>/${dcol_1xa1}/g"
echo "s/<wallbash_1xa2>/${dcol_1xa2}/g"
echo "s/<wallbash_1xa3>/${dcol_1xa3}/g"
echo "s/<wallbash_1xa4>/${dcol_1xa4}/g"
echo "s/<wallbash_pry2>/${dcol_pry2}/g"
echo "s/<wallbash_txt2>/${dcol_txt2}/g"
echo "s/<wallbash_2xa1>/${dcol_2xa1}/g"
echo "s/<wallbash_2xa2>/${dcol_2xa2}/g"
echo "s/<wallbash_2xa3>/${dcol_2xa3}/g"
echo "s/<wallbash_2xa4>/${dcol_2xa4}/g"
echo "s/<wallbash_pry3>/${dcol_pry3}/g"
echo "s/<wallbash_txt3>/${dcol_txt3}/g"
echo "s/<wallbash_3xa1>/${dcol_3xa1}/g"
echo "s/<wallbash_3xa2>/${dcol_3xa2}/g"
echo "s/<wallbash_3xa3>/${dcol_3xa3}/g"
echo "s/<wallbash_3xa4>/${dcol_3xa4}/g"
