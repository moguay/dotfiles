...
51|30|top|*\ custom/arch \* ( custom/monitor ) ( custom/cliphist custom/wbar custom/theme custom/wallchange custom/wallbash cava ) ( hyprland/workspaces )|( wlr/taskbar )|( hyprland/submap tray ) ( custom/updates ) ( custom/weather backlight network bluetooth pulseaudio#microphone pulseaudio custom/notifications )
